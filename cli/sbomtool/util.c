 ...
 * !doc
 *
 * .. c:function:: void sbomtool_util_set_key(pkgconf_client_t *client, const char *key, const char *key_value, const char *key_default)
 *
 ...
 * !doc
 *
 * .. c:function:: void sbomtool_util_set_uri_root(pkgconf_client_t *client, const char *uri_root)
 *
...
{
	sbomtool_util_set_key(client, "spdx_uri_root", uri_root, "https://github.com/pkgconf/pkgconf");
}

/*
 * !doc
 *
 * .. c:function:: const char *sbomtool_util_get_uri_root(pkgconf_client_t *client)
 *
 *    Get current URI
 *
 *    :param pkgconf_client_t* client: The pkgconf client being accessed.
 ...
 * !doc
 *
 * .. c:function:: void sbomtool_util_set_uri_separator_colon(pkgconf_client_t *client, bool is_colon)
 *
 ...
 */
void
sbomtool_util_set_uri_separator_colon(pkgconf_client_t *client, bool is_colon)
{
	if (is_colon == true)
		client->flags |= SBOMTOOL_SEPARATOR_COLON;
	else
		client->flags = client->flags & ~SBOMTOOL_SEPARATOR_COLON;
}

/*
 * !doc
 *
 * .. c:function:: char sbomtool_util_get_uri_separator(pkgconf_client_t *client)
 *
 *    Get separator char
 *
 *    :param pkgconf_client_t* client: The pkgconf client being accessed.
...
{
	if (client->flags & SBOMTOOL_SEPARATOR_COLON)
		return ':';
 ...
 * !doc
 *
 * .. c:function:: void sbomtool_util_set_spdx_version(pkgconf_client_t *client, const char *spdx_version)
 *
...
{
	sbomtool_util_set_key(client, "spdx_version", spdx_version, "3.0.1");
}

/*
 * !doc
 *
 * .. c:function:: const char *sbomtool_util_get_spdx_version(pkgconf_client_t *client)
 *
 ...
 * !doc
 *
 * .. c:function:: void sbomtool_util_set_spdx_license(pkgconf_client_t *client, const char *spdx_license)
 *
...
{
	sbomtool_util_set_key(client, "spdx_license", spdx_license, "CC0-1.0");
}

/*
 * !doc
 *
 * .. c:function:: char *sbomtool_util_get_spdx_id_int(pkgconf_client_t *client, char *part)
 *
...
sbomtool_util_get_spdx_id_int(pkgconf_client_t *client, const char *part)
{
	...
	const char *global_xsd_any_uri = sbomtool_util_get_uri_root(client);
	char sep = sbomtool_util_get_uri_separator(client);
 ...
 * !doc
 *
 * .. c:function:: char *sbomtool_util_get_spdx_id_string(pkgconf_client_t *client, const char *part, const char *string_id)
 *
 *    Get string id URI
 ...
 * !doc
 *
 * .. c:function:: char *sbomtool_util_get_iso8601_time(time_t *wanted_time)
 *
 ...
 * !doc
 *
 * .. c:function:: char *sbomtool_util_get_current_iso8601_time(void)
 *
...
sbomtool_util_get_current_iso8601_time(void)
{
	...
	return sbomtool_util_get_iso8601_time(&now);
}

/*
 * !doc
 *
 * .. c:function:: char *sbomtool_util_string_correction(char *str)
 *
 ...
 * !doc
 *
 * .. c:function:: char *sbomtool_util_tuple_lookup(pkgconf_client_t *client, pkgconf_list_t *vars, const char *key)
 *
 *    Lowercase string and change spaces to '_'
 *
